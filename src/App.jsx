...
export default function about() { 
    ...
    <div>
      ...
      <div className="landing-info-container">
          <i> Hello and welcome to my website! I'm Shawn, an aspiring computational biologist and data scientist. Click on one of the icons below to check out the projects I'm working on!</i>
      </div>
